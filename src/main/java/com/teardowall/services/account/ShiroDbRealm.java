...
public class ShiroDbRealm extends AuthorizingRealm {
  ...
  protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
    ...
    return new SimpleAuthenticationInfo(new ShiroUser(new Long(user.getId()), "dd", user.getName()), "dd", getName());
  ...
  protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
    ...
    try {
      ...
      int result = 1;//accountService.update_logged(shiroUser.id);
      if (result == 0) {
...
//  }
  ...
  public void initCredentialsMatcher() {
    HashedCredentialsMatcher matcher = null;//new HashedCredentialsMatcher(AccountService.HASH_ALGORITHM);
